        ...
        <section>
          ...
          <section className="developing__Banner">
            <article className="developing">
              ...
              <p className="developing__Text"> My skill set is based on front end development, and I'm continuing to work on those aspects of my abilities. Currently however I have begun to learn PHP and that has been fun to learn. </p>
